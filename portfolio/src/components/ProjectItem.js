function ProjectItem({ title, duration, projectType, platform, languages }) {
  return (
    <div className="flex md:flex-row flex-col-reverse flex-col justify-end py-10">
      <div className="flex md:mr-5 flex-col-reverse md:flex-col">
        <div className="-mr-2 pt-2">{languages}</div>
        <div className="grow md:self-start text-right flex items-end justify-end">
