    ...
    return (
        <div className="w-8/12 md:w-7/12 lg:w-6/12 pb-5 sm:pb-0 md:px-20 px-10 xl:text-base text-xs text-right contentpage sm:pt-36 pt-64 flex flex-col">
            <WorkExpCard
                ...
                languages={<div className="flex justify-end"><CsharpIcon/> <DotnetCoreIcon/> <PythonIcon/> <ReactIcon/> <SqlIcon/> <TypescriptIcon/> <BootstrapIcon/></div>}
            />
            <WorkExpCard
                title={"CSIntelligence"}
            ...
            <WorkExpCard
                ...
                languages={<div className="flex justify-end"> <HtmlIcon/> <CssIcon/> <JavascriptIcon/> <BootstrapIcon/> <DockerIcon/></div>}
            />
        </div>
    );
}
