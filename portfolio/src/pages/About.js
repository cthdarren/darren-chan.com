      ...
      <div className='container h-100 '>
        <div className='row mt-5'>
          <div className='col-6 col-md-4 col-lg-3 h-100  shadow rounded-bottom p-4 pt-5'>
            <img className="rounded-circle" width="60%" alt="" src="https://media.licdn.com/dms/image/D5603AQHORHkYYsqUoQ/profile-displayphoto-shrink_800_800/0/1708154569571?e=1716422400&v=beta&t=uGYBnZvGuVPBvy73e07coAs_dECZl1oDm49uZmYxEL8" ></img>
          ...
          <div className='text-start ps-5 pt-5 col  h-100'>
            ...
            <a target="_blank" href="https://quagsirecdn.sgp1.cdn.digitaloceanspaces.com/Resume%20Darren.pdf" className='btn btn-outline-primary me-2' rel="noreferrer">my resume here.</a>
