function Home() {
    return (
        <div className="w-8/12 md:w-7/12 lg:w-6/12 xl:w-4/12 pb-5 sm:pb-10 md:px-20 px-10 xl:text-base text-xs text-left contentpage self-end">
            ...
            <br />
            <br /> My programming journey began in 2017. I had begun taking a
